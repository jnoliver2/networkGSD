<form class="aj_form">
<div id="AddClientPrivate" class="modal myModal fade" tabindex="-1" data-width="760" style="display: none;">
    ...
    <div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					...
					<input type="text"  placeholder="" class="form-control" id="newClientPrivate" name="Name">
					</div>
